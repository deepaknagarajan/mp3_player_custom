...
# IMPORTANT: import vlc after DLL path is made visible
import vlc
...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.status = QLabel(
            "Tip: Drag & drop MP3 files/folders. Space=Play/Pause, "
    ...
    def _read_metadata(self, path: Path) -> Track:
        ...
        try:
            ...
            if audio is not None:
                ...
                if tags:
                    title = (
                        _safe_str(tags.get("TIT2") or tags.get("title")) or title
                    )
    ...
    def play_next(self) -> None:
        ...
        self.history.append(self._current_track_index())
    ...
    def _tick(self) -> None:
        ...
        if length > 0:
            ...
            # duration unknown yet: keep UI stable
            self.slider.blockSignals(True)
            self.slider.setValue(0)
            self.slider.blockSignals(False)

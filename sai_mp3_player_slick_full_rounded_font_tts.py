...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        # Text-to-speech engine (offline; uses Windows SAPI)
    ...
    # ---------------- Speak track name ----------------
    def _speak_track_name(self, track: Track) -> None:
        """
        Speak the MP3 filename (without extension) in a background thread
        so playback + UI are not blocked.
        """
    ...
    def _update_now_playing_highlight(self) -> None:
        # Clear previous marker (if still visible)
    ...
    def _load_current_and_play(self) -> None:
        ...
        # Announce the filename (no extension) at start of track
        self._speak_track_name(t)
